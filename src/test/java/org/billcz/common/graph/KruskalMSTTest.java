...
import org.billcz.common.algorithm.graph.KruskalMST;
...
public class KruskalMSTTest {
    ...
    public static void main(String[] args) {
        ...
        KruskalMST kruskalMSTTest = new KruskalMST(graph);
        Iterable<Edge> mst = kruskalMSTTest.edges();

        for (Edge e : mst) {
            System.out.println(e);
        }
        System.out.println("weight: " + kruskalMSTTest.weight());
    }
}
